...
<a href="#" class=" mt-10 block  w-full p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 " style={{paddingRight:10,height:500}}>
...
<div class="flex items-start gap-2.5 pb-3">
